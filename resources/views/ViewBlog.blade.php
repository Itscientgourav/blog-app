    ...
    <div class="container container-flex">
        <main role="main">
            <article class="article-featured">
                <h2 class="article-title">{{$viewBlog->blog_title}}</h2>
                <img src="{{ url('fetch-images/' . $viewBlog->blog_img) }}" class="article-image">
                <p class="article-info">{{ \Carbon\Carbon::parse($viewBlog->blog_post_date)->format('F d, Y') }}</p>
                <p class="article-body">{{$viewBlog->blog_body}}</p>
            </article>
